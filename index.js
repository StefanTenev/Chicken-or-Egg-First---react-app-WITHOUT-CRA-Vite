...
/*
  CREATING IMPORTS WITH BABEL - STANDALONE REQUIRES EXTRA SCRIPTS AND MANAGEMENT, THIS PROJECT IS MEANT TO BE A VERY SIMPLE PROJECT
  FOR TESTING, WITH CRA, VITE, ETC.

  I HAVE THEREFORE NOT INCLUDED THE IMPORTS OF THE COMPONENTS, AND HAVE ALL SET UP HERE, WHILST STILL SETTING UP COMPNENTS FOLDER AND 
  COMMENTED-OUT IMPORTS.

  WITH ALL THAT, THIS IS STILL A COMPONENT-BASED REACT APP AND REGARDLESS OF WHETHER THE COMPONENTS ARE ORGANIZED OR NOT, THEY ARE STILL
  COMPONENTS AND FUNCTION IN THE SAME WAY
*/
